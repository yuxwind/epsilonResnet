...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        def first_block(name, l):
            ...
            grp = int(name[3])
            if discard_first_block[grp-1] == 1:
...
if __name__ == '__main__':
    ...
    if args.cfg:
        global is_cifar_model, structure, discard_first_block
