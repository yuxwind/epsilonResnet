...
python cifar10-epsilon-resnet.py --gpu 2 -n 18 -e 2.5 -o cifar10-e_2.5-n_18 --cifar10
...
python cifar10-epsilon-resnet.py --gpu 2 -n 33 -e 2.5 -o cifar10-e_2.5-n_33 --cifar10
#   run epsilon ResNet 500 with epsilon=2.5
python cifar10-epsilon-resnet.py --gpu 2 -n 83 -e 2.5 -o cifar10-e_2.5-n_83 --cifar10
#   run epsilon ResNet 750 with epsilon=2.5
python cifar10-epsilon-resnet.py --gpu 2 -n 125 -e 2.5 -o cifar10-e_2.5-n_125 --cifar10
