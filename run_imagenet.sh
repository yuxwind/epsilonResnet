...
python imagenet-epsilon-resnet.py --gpu 0,1,2,3 --data /scratch/yuxwind/tensorpack_data/ilsvrc12_data/ -d 101 -e 2.0 
...
python imagenet-compressed-resnet.py --cfg train_log.imagenet-e_2-d_101/imagenet-epsilon-resnet/compressed_model_550000.cfg --data /scratch/yuxwind/tensorpack_data/ilsvrc12_data/ --gpu 2  
...
python imagenet-epsilon-resnet.py --gpu 0,1,2,3 --data /scratch/yuxwind/tensorpack_data/ilsvrc12_data/ -d 101 -e 2.1 
mv train_log train_log.imagenet-e_2.1-d_101
# run epsilon-ResNet 152 with epsilon=1.8
python imagenet-epsilon-resnet.py --gpu 0,1,2,3,4,5 --data /scratch/yuxwind/tensorpack_data/ilsvrc12_data/ -d 152 -e 1.8
